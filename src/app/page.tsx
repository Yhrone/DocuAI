    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to have consversation with any PDF document.Simply
      ...
      <div>
        <div className="relative isolate">
          <div
            aria-hidden="true"
            className="pointure-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
          >
            <div
              style={{
                clipPath:
      ...
      {/* Feature section */}
      <div className="max-auto m-32 mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        {/* steps */}
        {/* steps */}
        <ol className="my-8 ml-20  space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
